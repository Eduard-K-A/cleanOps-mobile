...
export default function EmployeePayoutMethodsScreen() {
  ...
  return (
    <View style={[st.container, { backgroundColor: C.bg }]}>
      <View style={[st.topBar, { backgroundColor: C.surface, borderBottomColor: C.divider, paddingTop: insets.top }]}>
        ...
        <Text style={[st.topTitle, { color: C.text1 }]}>Payout Methods</Text>
        <View style={{ width: 40 }} />
      </View>

      <ScrollView contentContainerStyle={st.scroll}>
        <Text style={[st.sectionTitle, { color: C.text1 }]}>Saved Payout Accounts</Text>
        ...
        {loading ? (
          ...
          <View style={st.emptyState}>
            ...
            <Text style={[st.emptyText, { color: C.text3 }]}>No payout methods added yet.</Text>
          </View>
        ) : (
        ...
        >
          ...
          <Text style={[st.addMethodBtnText, { color: C.blue600 }]}>Add New Payout Method</Text>
        </TouchableOpacity>
      </ScrollView>
                ...
                {paymentFlow === 'details' ? (
                  <>
                    ...
                    <TouchableOpacity style={st.confirmBtn} onPress={handleAddPaymentMethod} disabled={isProcessing}>
                      <LinearGradient colors={['#22c55e', '#16a34a']} style={st.btnGradient}>
                        {isProcessing ? <ActivityIndicator color="#fff" /> : <Text style={st.confirmBtnText}>Add Payout Method</Text>}
                      </LinearGradient>
                    </TouchableOpacity>
                  </>
                ) : (
...
const st = StyleSheet.create({
  ...
  defaultBadge: { backgroundColor: 'rgba(34, 197, 94, 0.1)', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 },
  defaultBadgeText: { fontSize: 11, color: '#22c55e', fontWeight: '700' },
  removeBtn: { padding: 8 },
